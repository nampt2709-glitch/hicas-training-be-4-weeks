using Asp.Versioning; // [ApiVersion]: khai báo 2.0 trên URI api/v2/...
...

{
    ...
    // [2] GET /api/v{version}/users/{id}
    [HttpGet("{id:guid}")] // GET một user theo id.
    ...
    // [4] PUT /api/v{version}/users/{id}
    // User (không phải Admin): chỉ sửa Name của chính mình; Admin phải dùng PUT admin versioned.
    ...
    // [5] PUT /api/v{version}/admin/users/{id}
    ...
    // [6] DELETE /api/v{version}/users/{id}
